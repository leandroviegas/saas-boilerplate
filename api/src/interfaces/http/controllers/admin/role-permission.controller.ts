...
import { organizationRolePermissionService } from "@/application";
import { OrganizationRolePermissionsSchema } from "@/interfaces/http/schemas/models/organization-role-permission.schema";
