  ...
  return (
    <div className="container mx-auto max-w-2xl py-12 px-4">
      <Card className="w-full">
        <CardHeader>
          <CardTitle className="text-2xl">{t('checkout_summary')}</CardTitle>
        ...
        <CardContent className="space-y-6">
          <div className="rounded-lg bg-muted p-4">
            ...
            <div className="space-y-2">
              <p className="text-sm font-medium">{t('included_features')}:</p>
          ...
          <div className="space-y-2">
            <Label htmlFor="promo">{t('promotion_code')}</Label>
